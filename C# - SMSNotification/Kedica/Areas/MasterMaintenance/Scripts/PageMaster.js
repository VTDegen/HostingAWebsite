...
(function () {
    ...
    $(document).ready(function () {
        ...
        $('#btnPrintPDFPage').click(function () {
            //printPDFPage();
        });
        ...
        function printPDFPage() {
            var cookieVal = $("#PageCookieID").val();
            location.assign("/MasterMaintenance/PageMaster/PrintPDFPage?CookieVal=" + cookieVal);
            checkCookie();
        }
        function checkCookie() {
            var cookieVal = $.cookie($("#PageCookieID").val());
            ...
            if (cookieVal == null || cookieVal === 'undefined') {
                ...
                Page.showSuccess("Page was successfully printed.");
                $.removeCookie($("#PageCookieID").val(), { path: '/' });
