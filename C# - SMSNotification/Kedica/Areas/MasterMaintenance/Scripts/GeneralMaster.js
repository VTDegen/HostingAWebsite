...
(function () {
    ...
    $(document).ready(function () {
        ...
        function drawDatatables() {
            if (!$.fn.DataTable.isDataTable('#tblGeneral')) {
                tblGeneral = $('#tblGeneral').DataTable({
                    ...
                    "pageLength": 25,
                    "ajax": {
                        "url": "/DropDownDetails/SelectField/GetGeneralList",
                        "type": "POST",
                        "datatype": "json",
                        "data": function (d) {
                            d.TypeID = editIDType;
            ...
            if (!$.fn.DataTable.isDataTable('#tblType')) {
                tblType = $('#tblType').DataTable({
                    ...
                    "pageLength": 25,
                    "ajax": {
                        "url": "/DropDownDetails/SelectField/GetTypeList",
                        "type": "POST",
                        "datatype": "json",
                    },
        ...
        function validateValue() {
            ...
            if (type && type) {
                General.formAction = '/DropDownDetails/SelectField/ValidateValue';
        ...
        function saveGeneral() {
            ...
            General.formAction = '/DropDownDetails/SelectField/SaveGeneral';
        ...
        function editGeneral() {
            General.formAction = '/DropDownDetails/SelectField/GetGeneralDetails';
        ...
        function deleteGeneral() {
            General.formAction = '/DropDownDetails/SelectField/DeleteGeneral';
            General.jsonData = { ID: editIDGeneral };
            General.sendData().then(function () {
                tblGeneral.ajax.reload(null, false);
                cancelGeneralTbl();
        ...
        function validateType() {
            ...
            if (type) {
                General.formAction = '/DropDownDetails/SelectField/ValidateType';
        ...
        function saveType() {
            ...
            General.formAction = '/DropDownDetails/SelectField/SaveType';
            General.setJsonData().sendData().then(function () {
                cancelTypeTbl();
                cancelTypeForm();
        ...
        function editType() {
            General.formAction = '/DropDownDetails/SelectField/GetTypeDetails';
            if (General.formAction) {
        ...
        function deleteType() {
            General.formAction = '/DropDownDetails/SelectField/DeleteType';
            General.jsonData = { ID: editIDType };
            General.sendData().then(function () {
                tblType.ajax.reload(null, false);
                tblGeneral.ajax.reload(null, false);
