using SMSNofication.Areas.MasterMaintenance.Models;
...
namespace SMSNofication.Areas.DropDownDetails.Controllers
{
    public class SelectFieldController : Controller
    {
        DataHelper dataHelper = new DataHelper();
        List<string> modelErrors = new List<string>();
        bool error = false;
        string errmsg = "";
        // GET: DropDownDetails/SelectField
        public ActionResult Index()
        {
            return View("SelectField");
        }
